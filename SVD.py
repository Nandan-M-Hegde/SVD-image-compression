...
#Seperating red, green and blue color values as 3 sepearte matrices
img_red = im[:,:,0]
img_green = im[:,:,1]
img_blue = im[:,:,2]

#Now we have 3 matrices having corresponding RGB values
#Now we perform SVD on these 3 matrices seperately
...
#Getting the size of the matrix tells us the resolution of the image
